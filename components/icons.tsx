...
export const CalculatorIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M12 8h.01M15 8h.01M15 14h.01M18 10a6 6 0 11-12 0 6 6 0 0112 0z" />
  </svg>
);
...
export const MenuIcon: React.FC<{ className?: string, onClick?: () => void }> = ({ className, onClick }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const SlidersIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6V4m0 16v-2m8-10v2m-8 4h.01M6 12h.01M18 12h.01M6 12a2 2 0 11-4 0 2 2 0 014 0zm12 0a2 2 0 11-4 0 2 2 0 014 0zM12 18a2 2 0 11-4 0 2 2 0 014 0zm0-12a2 2 0 11-4 0 2 2 0 014 0z" />
  </svg>
);

export const PieChartIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 3.055A9 9 0 0121.945 13H11V3.055z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 21.945V13H3.055A9 9 0 0113 21.945z" />
  </svg>
);
...
export const TrashIcon: React.FC<{ className?: string; onClick?: () => void }> = ({ className, onClick }) => (
    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const PencilIcon: React.FC<{ className?: string, onClick?: () => void }> = ({ className, onClick }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const CheckIcon: React.FC<{ className?: string, onClick?: () => void }> = ({ className, onClick }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const ShareIcon: React.FC<{ className?: string, onClick?: () => void }> = ({ className, onClick }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
  </svg>
);

export const RefreshIcon: React.FC<{ className?: string, onClick?: () => void }> = ({ className, onClick }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} onClick={onClick} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const CubeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.353v9.294a1.5 1.5 0 01-.757 1.303l-8.25 4.732a1.5 1.5 0 01-1.486 0l-8.25-4.732A1.5 1.5 0 012 16.647V7.353a1.5 1.5 0 01.757-1.303l8.25-4.732a1.5 1.5 0 011.486 0l8.25 4.732A1.5 1.5 0 0121 7.353z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 22.5V12m0 0L2.5 6.5M12 12l9.5-5.5" />
  </svg>
);
